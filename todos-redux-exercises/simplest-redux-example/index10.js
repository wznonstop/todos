...
//第二版：前一个 todos 对应之前的 state.todos, 后一个 todos 对应 todos 函数。意思是 todos 这个属性会被 todos 这个函数更新。
...
//第一版：todoApp 作为一个 store, 在它里面定义的东西决定了最终呈现在 state 里面的数据的结构。此处就是分为两个属性: todos,visibilityFilter
